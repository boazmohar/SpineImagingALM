function [bwCell_vol_numbered] = imCellEditInteractive_3DMA_090210(fovImg_vol,...
    bwCell_vol_numbered, zoomToAxis, cellRadius, Im_contrast)
global gv
...
%% process arguments
if nargin < 3 || isempty(zoomToAxis), timer
...
line(Zuse3*ones(1,2),zoomToAxis(3:4),'Color','g');
line(zoomToAxis(1:2),Zuse2*ones(1,2),'Color','g');
